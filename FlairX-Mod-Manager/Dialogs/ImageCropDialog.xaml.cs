...
{
    public sealed partial class ImageCropDialog : ContentDialog
    {
        ...
        public ImageCropDialog(System.Drawing.Image sourceImage, string cropType, int targetWidth, int targetHeight)
        {
            ...
            this.PrimaryButtonText = SharedUtilities.GetTranslation(lang, "OK");
            this.SecondaryButtonText = SharedUtilities.GetTranslation(lang, "Cancel");
            ...
            DescriptionText.Text = SharedUtilities.GetTranslation(lang, "CropDialog_Description") ?? 
                "Drag the crop area or resize using corner handles. The aspect ratio is locked.";
            
            InfoText.Text = SharedUtilities.GetTranslation(lang, "CropDialog_Info") ?? 
                "Click and drag to move the crop area. Use corner handles to resize while maintaining aspect ratio.";
            
            TargetSizeText.Text = $"Target: {targetWidth}×{targetHeight}";
            
            this.Loaded += ImageCropDialog_Loaded;
        }
